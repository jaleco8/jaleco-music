#!/bin/bash
BASE="src/content/courses/english-beginner/cap02-either-or-stories"
...
declare -a SECTIONS=(
  ...
  "06|phrasal-verbs|Phrasal Verbs"
  "07|body-parts|Body Parts"
  "08|movies-tv|Movies & TV"
  "09|animals|Animals"
  "10|culture|Culture"
  "11|exercise|Exercise"
  "12|listening-phases|Las 4 fases de la escucha"
  "13|hobbies|Hobbies"
  "14|holidays|Holidays"
  "15|hometown|Hometown"
  "16|work|Work"
  "17|love|Love"
  "18|speaking-phases|Las 5 fases del habla"
  "19|household-items|Household Items"
  "20|time|Time"
  "21|weather|Weather"
  "22|music|Music"
  "23|numbers|Numbers"
  "24|testimonial-access|Accesos exclusivos por testimonio"
  ...
  cat > "$dir/lesson.json" << EOF
{
  "id": "${id}",
  "title": "${title}",
  "chapterId": "cap02-either-or-stories",
  "order": ${num#0},
  "estimatedMinutes": 8,
  "tags": [],
